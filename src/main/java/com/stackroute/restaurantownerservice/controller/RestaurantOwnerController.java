...
public class RestaurantOwnerController {
	...
	@PostMapping("/signup")
	public ResponseEntity<?> saveUser(@RequestBody RestaurantOwner owner) throws RestaurantOwnerAlreadyExistsException{
		try {
			RestaurantOwner createdRestaurantOwner = restaurantOwnerService.registerOwner(owner);
